...
:x_opt_e_arg: pass:n[<__name__>]
:x_opt_e_name: pass:n[**-e**]
:x_opt_e_name_arg: pass:n[**-e**{nbsp}<__name__>]
:x_opt_engine_arg: pass:n[<__name__>]
:x_opt_engine_name: pass:n[**--engine**]
:x_opt_engine_name_arg: pass:n[**--engine=**<__name__>]
...
:x_opt_e_arg: pass:n[``<name>``]
:x_opt_e_name: pass:n[``-e``]
:x_opt_e_name_arg: pass:n[``-e{nbsp}<name>``]
:x_opt_engine_arg: pass:n[``<name>``]
:x_opt_engine_name: pass:n[``--engine``]
:x_opt_engine_name_arg: pass:n[``--engine=<name>``]
...
{x_opt_engine_name_arg}, {x_opt_e_name_arg}:: Use the specified engine
instead of automatically picking an engine.
